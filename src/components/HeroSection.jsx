...
function HeroSection() {
  ...
  return (
    <div className='flex flex-col justify-center items-center text-center h-[80svh] gap-8 relative'>
      <h1 className={`${width > 630 ? "text-[50px]" : "text-[35px]"} ${width > 1000 ? "w-[50%]" : ""} text-[35px] font-black leading-[120%] tracking-[3%]`}>Twoja przestrzeń do nauki <span className='text-primary'>JavaScript</span> od podstaw</h1>
